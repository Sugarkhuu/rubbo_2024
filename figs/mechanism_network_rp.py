...
SHOCK = "eps_rp"  # risk-premium/UIP shock
HORIZON = 20
...
fig.suptitle("Risk-premium/UIP shock, real Chile calibration -- each row a regime", fontsize=10, color="#52514e", y=1.055)
fig.tight_layout()
fig.savefig(os.path.join(REPO_ROOT, "figs", "mechanism_network_rp.pdf"), facecolor=fig.get_facecolor(), bbox_inches="tight")
fig.savefig(os.path.join(REPO_ROOT, "figs", "mechanism_network_rp.png"), facecolor=fig.get_facecolor(), bbox_inches="tight")
print("saved")
