...
if T_flag
    T = oen_impint_0p5000_managed.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(49, 1);
    ...
    residual(38) = (log(y(48)/params(26))) - (params(27)*y(55)+params(28)*y(56)+params(29)*log(y(44)));
