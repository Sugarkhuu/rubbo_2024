...
\setbeamercolor{itemize subitem}{fg=customgreen!60!black}
...
% -- accent-underlined frame title (adds a thin separator below the green bar)
\setbeamertemplate{frametitle}{%
  \nointerlineskip
  \begin{beamercolorbox}[wd=\paperwidth,leftskip=1em,ht=1.25cm,dp=0pt,vmode]{frametitle}
    \vbox to 1.25cm{\vfil\usebeamerfont{frametitle}\insertframetitle\vfil}
  \end{beamercolorbox}%
  {\color{customgreen!45!white}\rule{\paperwidth}{0.6pt}}%
}

% -- colored emphasis: bold text picks up the theme accent instead of flat black
\let\plainbf\textbf
\renewcommand{\textbf}[1]{\textcolor{customgreen!55!black}{\plainbf{#1}}}

% -- theme-colored table rules
\arrayrulecolor{customgreen!55!black}

% -- section markers on the outline page
\setbeamertemplate{section in toc}{\color{customgreen!60!black}\bfseries\inserttocsectionnumber.~\inserttocsection}
