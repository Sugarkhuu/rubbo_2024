...
{\tiny \textbf{Note:} computed under the aggregate-export specification; the interior-optimum mechanism (UIP leak-in vs.\ autonomy loss) is unrelated to the export side.}
