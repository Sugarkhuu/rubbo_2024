...
OH21    = 0.200000;      // Manuf. <- Resource (domestic)
OH32    = 0.250000;      // Services <- Manuf. (domestic)

OF1     = 0.300000;      // Resource: imported machinery
OF2     = 0.100000;      // Manufacturing: imported components
OF3     = 0.050000;      // Services: indirect imports
