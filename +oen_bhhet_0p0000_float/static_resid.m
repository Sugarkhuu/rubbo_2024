...
if T_flag
    T = oen_bhhet_0p0000_float.static_resid_tt(T, y, x, params);
end
residual = zeros(51, 1);
    ...
    residual(34) = (y(37)) - (params(26)*(1-params(22)*(y(36)-params(25)))*y(42));
    residual(35) = (y(36)) - (y(36)*y(37)/y(30)+(y(28)*y(38)-y(35)*y(39))/y(29));
    residual(36) = (y(38)) - (params(24)*y(40)*y(41)*T(31));
    residual(37) = (y(39)) - (y(27)+y(1)*y(13)*params(13)/y(35)+y(2)*y(14)*params(14)/y(35)+y(3)*y(15)*params(15)/y(35));
    residual(38) = (log(y(37)/params(26))) - (params(27)*y(46)+params(28)*y(47));
    residual(39) = (y(46)) - (params(41)*log(y(10))+params(42)*log(y(11))+params(43)*log(y(12)));
    residual(40) = (y(48)) - (params(35)*(log(y(1)/(y(1)))-log(y(43))));
    residual(41) = (y(49)) - (params(36)*(log(y(2)/(y(2)))-log(y(44))));
    residual(42) = (y(50)) - (params(37)*(log(y(3)/(y(3)))-log(y(45))));
    residual(43) = (y(47)) - (y(50)+y(48)+y(49));
    residual(44) = (log(y(43))) - (log(y(43))*params(30)+x(1));
    residual(45) = (log(y(44))) - (log(y(44))*params(30)+x(2));
    residual(46) = (log(y(45))) - (log(y(45))*params(30)+x(3));
    residual(47) = (log(y(34))) - (log(y(34))*params(31)+x(4));
    residual(48) = (log(y(40))) - (log(y(40))*params(32)+x(5));
    residual(49) = (log(y(41))) - (log(y(41))*params(33)+x(6));
    residual(50) = (log(y(42))) - (log(y(42))*params(34)+x(7));
