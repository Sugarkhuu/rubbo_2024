% =========================================================================
% TASK #2 (todo_three_exercises.txt), FULL VERSION: run the sector-specific
% export-demand Chile model (open_economy_network_chile_exp*.mod) under
% all three FX regimes and export IRFs, theoretical variances, and derived
% network objects to results_chile_exp/*.csv -- mirrors
% code/run_chile_regimes.m exactly, just pointed at the _exp .mod files
% and a separate output folder (baseline results_chile/ untouched).
%
% Run from the REPO ROOT:
%   >> addpath('C:\dynare\6.3\matlab'); addpath('code'); run_chile_exp_regimes
% =========================================================================

regimes = {'float', 'peg', 'managed'};
modfiles = struct('float', 'open_economy_network_chile_exp', ...
                   'peg', 'open_economy_network_chile_exp_peg', ...
                   'managed', 'open_economy_network_chile_exp_managed');
